...
(function () {
    ...
    var chartModule = {
        ...
        renderWorkYearSalary : function (id, workYearSalary,city) {
            ...
            cityData.sort(function (a, b) {
                return  a._id.localeCompare(b._id);    //对象键值对是无序的，按照_id 排序,排序结果是1-3年，10年以下，1年以下，3-5年，5-10年,不限，应届毕业生
            });


            var renderData = [[],[]];
            var x = (cityData.length == 7) ? ['应届毕业生','1年以下','1-3年','3-5年','5-10年','10年以上','不限'] : ['应届毕业生','1年以下','1-3年','3-5年','5-10年','不限'];
            var sort = (cityData.length == 7) ? [6,2,0,3,4,1,5] : [5,1,0,2,3,4];   //手动计算出预想中的排序，囧。
            ...
            for (var i = 0 ,len= cityData.length; i < len; i++) {
                ...
                renderData[0].push( typeof cityData[ sort[i] ] == "undefined" ? 0 : cityData[ sort[i] ].sum);  //招聘总数
                renderData[1].push( parseInt( typeof cityData[ sort[i] ] == "undefined" ? 0 : cityData[ sort[i] ].aveSalary ) ); //平均工资
            }
